...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "firstPolicy":
            MessageLookupByLibrary.simpleMessage("1. المقدّمة والتعريفات"),
        "firstPolicyDescription": MessageLookupByLibrary.simpleMessage(
            "تقدم هذه السياسة مقدمة عن المتجر الإلكتروني، وتحدد التعريفات الأساسية المستخدمة في الاتفاقية، مثل تعريف المتجر، العميل، الخدمة، المنتج، وغيرها من المصطلحات ذات الصلة."),
        ...
        "fourthPolicyDescription": MessageLookupByLibrary.simpleMessage(
            "يجب على العميل استخدام المنصة وفقاً للأنظمة والأخلاق العامة ولا يجوز له استخدام الخدمة مخالفاً للقوانين المعمول بها."),
        ...
        "locationApartmentNumber":
            MessageLookupByLibrary.simpleMessage("رقم الشقة"),
        "locationApartmentNumberHint": MessageLookupByLibrary.simpleMessage(
            "أدخل رقم الشقة (مثل 101، 202، إلخ)"),
        "locationBuilding":
        ...
        "secondPolicyDescription": MessageLookupByLibrary.simpleMessage(
            "يقر العميل بأن لديه القدرة القانونية الصالحة للتعامل مع المتجر والبالغ من العمر 18 سنة على الأقل. وفي حالة المخالفة، يتحمل العميل العواقب."),
        "settings": MessageLookupByLibrary.simpleMessage("الإعدادات"),
        "sexthPolicy": MessageLookupByLibrary.simpleMessage(
            "6. الملكية الفكرية, خدمات الدفع, التعديلات, مسؤولية المتجر, قيود الوصول, والقوانين المعمول بها"),
